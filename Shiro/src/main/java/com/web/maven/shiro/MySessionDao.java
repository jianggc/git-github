...
import com.web.maven.utils.SerializableUtils;
...
public class MySessionDao extends EnterpriseCacheSessionDAO {
	...
	protected Session doReadSession(Serializable sessionId) {
		...
		if (sessionStrList.size() == 0){
			System.out.println(" sessionId : "+sessionId +" can't get session");
			return null;
		}
		System.out.println("从数据库根据sessionId ："+sessionId+"  获取的session ： "+sessionStrList.get(0));
